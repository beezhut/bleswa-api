...
class User(AbstractUser):
    ...
    reporting_to = models.ForeignKey('User', null=True, blank=True, on_delete=models.PROTECT)
    ROLES = (
        ("AGENT", "Agent"),
...
class Task(BaseModel):
    assigned_to = models.ForeignKey(User, null=True, on_delete=models.PROTECT)
